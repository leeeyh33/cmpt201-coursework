[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/5YBWSsZd)
...
* SHA256: you need to use the OpenSSL `libcrypto` library to generate a SHA256 hash. OpenSSL's man
  ...
  provides a good introduction to how to use the library. You can refer to the section [Using Algorithms in Action](https://docs.openssl.org/3.2/man7/ossl-guide-libcrypto-introduction/#using-algorithms-in-applications), or their wiki page on [message digests](https://wiki.openssl.org/index.php/EVP_Message_Digests) to see examples of calling SHA256 hash functions.
...
* You also need to write `CMakeLists.txt` that produces one executable, `blockchain`. The executable
  should run the main function in `src/main.c`.  **Be very careful about file names and
