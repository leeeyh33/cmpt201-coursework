...
void *client_thread(void *arg) {
  ...
  while (1) {
    ...
    if ((uint8_t)buf[0] == 0) {
      ...
      size_t out_len =
          1 + sizeof(uint32_t) + sizeof(uint16_t) + ((size_t)n - 1);
